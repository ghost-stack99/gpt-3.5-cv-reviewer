...
async function analyzeResume(resumeText,job) {
  ...
  const completion = await openAI.chat.completions.create({
      messages: messages = [
        { role: 'system', content: 'You are an HR Professional, skilled in analyzing CVs and Resumes. Use  <p> and <b> tags only to seperate different aspects and paragraph of 500 words' },
        { role: 'user', content: `Analyze the resume:\n${resumeText}\n Provide criticicism and feedbacks on how to improve their resume on the criteria Proffesional Summary , Objectives , Work Experience , Education and Specific and Pertinent Skills , the give rating on each criteria and give an overall score and at last rate their suitability for a job of ${job} and give a final summary` },
      ],
      model: "gpt-3.5-turbo",
    });
...
async function generatePDF(text,token,username) {
    ...
    <html>
      <head>
        <style>
          html {
            ...
            color: lightgrey; /* Set font color to light grey */
      ...
      <body >
        ...
        <div style = "background-color:black; padding-bottom: 200px;" >
          <div class="header">
            <img src="data:image/png;base64,${
              readFileSync('./assets/header.png').toString('base64')
            }" style="width: 100%;">
          </div>
          <h1 class="heading" style="text-align: center; text-decoration: underline;" >REPORT</h1>
